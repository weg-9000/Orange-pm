...
각 규칙(L1~L7)에 대해 PASS 케이스와 FAIL/WARN 케이스를 검증한다.
실행:
    python -m pytest lint_publication_syntax_test.py -q
    python lint_publication_syntax_test.py   # 내장 러너
"""
